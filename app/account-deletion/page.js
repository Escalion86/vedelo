    ...
    <main className="bg-white">
      <div className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-6 px-6 py-12 text-sm text-gray-700">
        ...
        <section className="flex flex-col gap-3">
          <h2 className="text-lg font-semibold text-black">Что будет удалено</h2>
          <p>Профиль, клиенты, мероприятия, задачи, настройки интеграций, мобильные сессии и другие данные рабочего пространства будут удалены или обезличены после проверки запроса.</p>
          <p>Данные, которые необходимо хранить по закону для бухгалтерского учёта, разрешения споров или предотвращения злоупотреблений, могут сохраняться только в требуемом объёме и на установленный законом срок.</p>
        </section>
        <AccountDeletionForm />
        <p>Если вы можете войти в приложение, используйте удаление из профиля: оно сразу завершит активные мобильные сессии. По вопросам обработки данных см. <Link href="/privacy" className="text-general underline">Политику конфиденциальности</Link>.</p>
      </div>
    </main>
  )
}
