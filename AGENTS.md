...
- Общие правила UI описаны в `docs/UI_CONVENTIONS.md`; перед изменением кнопок, плашек, полей и модалок прочитай этот файл. Используй существующие компоненты и токены темы вместо локальных цветовых решений.
